...
import HeroBg from "../assets/img/HomePageGraphic.png";
  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center ">
      ...
      >
          ...
          <div className="z-10 mt-32 md:basis-3/5">
            ...
            >
              ...
              <p className="mt-8 text-sm">
                Are you a book worm?! Then you are landed in correct place!{" "}
                <br />
        ...
        <div className="py-[6.5rem] flex-1 flex items-center relative">
          <img
            src={HeroBg}
            className=" ml-auto h-full w-full lg:w-auto lg:h-full"
            alt="hero-bg"
          />
        </div>
      </section>
        ...
        <motion.div>
          ...
          <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
            ...
            <div>
              ...
              >
                ...
                <p className="mb-5">
                  You can add your favourite books to your shelves and buy as
                  per your comfort. You can read books here before you buy it.
                  Isn't that great!! <br />
                  You'll get rewards for each buy and you can use those points
                  to buy other new books.
                </p>
              </motion.div>
          ...
          <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
            ...
            <div>
              ...
              >
                <p className="my-5">
                  Hurray!! Your nearby Public Libraries are now available at
                  your fingertips... <br />
                  You can now borrow or rent any books to read from your nearby
                  public libraries or you can read it here at your online desk
                  for <b className="text-primary-500">FREE</b>.
                </p>
                <p className="mb-5">
          ...
          <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
            ...
            <div>
              ...
              >
                ...
                <p className="mb-5">
                  You can join differernt communities as per your choice and
                  list your books on the communities and that's it! Wait for
                  other user to show interest in your books and there you go!!{" "}
                  <br /> <br />
                  Thinking about frauds?! liBRBary is the{" "}
                  <b className="text-primary-500">SAFEST</b> and{" "}
                  <b className="text-primary-500">SECURE</b> place to
                  reconciliate your identities, so no worries! and enjoy
                  READING...
                </p>
              </motion.div>
